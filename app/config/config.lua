return {
	...
	session_secret = "3584827dfed45b40328DFb6242bdf13b",

	-- 用于存储密码的盐，请一定要修改此值, 一旦使用不能修改，用户也可自行实现其他密码方案
	pwd_secret = "saltlp_secret_for_password",
	...
	upload_config = {
		dir = "/home/nginx/gitRp/openresty-china/static", -- 文件目录，修改此值时须同时修改nginx配置文件中的$static_files_path值
	},	
